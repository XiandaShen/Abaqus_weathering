...
C FOR CALCULATION
      PARAMETER(INTERVAL=2592000.0D0,AB=0.15D0,AR=3.0D0,CINCIN=1.0D0)
C FOR CONSTANT
...
C	 
     ...
     1 CINC,AINC,SMM,BMM,SMI,BMI,VSTRAINI,DAMAGE
C      
...
C      WRITE(6,*) STRESS		
     ...
     1 *CINCIN*AR	  
	  STATEV(7)=EGSTRAIN(1,1,1)
	  STATEV(8)=EGSTRAIN(1,2,2)
	  STATEV(9)=EGSTRAIN(1,3,3)	  
